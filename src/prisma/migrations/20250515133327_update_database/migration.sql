...
CREATE TABLE "Settings" (
    ...
    "detailsPrivacy" TEXT NOT NULL,
    "connectionsPrivacy" TEXT NOT NULL,
    "postsPrivacy" TEXT NOT NULL,
...
INSERT INTO "new_User" ("bio", "createdAt", "email", "fullName", "id", "passwordHash", "username") SELECT "bio", "createdAt", "email", "fullName", "id", "passwordHash", "username" FROM "User";
DROP TABLE "User";
